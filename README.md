...
The goal of this step is to use multiple plot types to visualize the gene expressions of the DE genes identified in step 9 by cuffdiff and summarized in step 10 in DE_genes_summary_table.csv. We will create 5 plots (Figures) using the R package cummeRbund and focus on Figures 3 and 4 in relatively more detail.
...
![Figure 3. Detailed volcano plot](final_results/3_volcano2.png)
