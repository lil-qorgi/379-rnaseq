...
The goal of this step is to use multiple plot types to visualize the gene expressions of the DE genes identified in step 9 by cuffdiff and summarized in step 10 in DE_genes_summary_table.csv. We will create 5 plots using the R package cummeRbund and focus on two of them (Figures a & b) in more detail.
TODO
...
In the interpretation, we will briefly describe the figures generated by cummeRbund, then focus on Figures 3 and 4 for further discussion.

### Short descriptions of all figures
The five figures are arranged in order of their creation in the cummeRbund.R script.
...
- Figure 3 is a direct descendant of Figure 2, adding red highlights for the genes with significant differential expression between the two treatments.
...
**Figure 4. Log-scale scatter plot of FPKM values for *Candida albicans* genes under Thiamine- (q2) versus under Thiamine+ (q1) treatment.**
...
**Figure 5. Bar plot of a *Candida albicans* gene, SNZ1, shows significantly higher gene expression (FPKM) levels under Thiamine- (q2) compared with Thiamine+ (q1) condition.**
...
Based on the results from GO enrichment analysis, we see several classifications overrepresented among the DE genes identified in step 9.

TODO
Within the functional (?) gene ontologies, <category> and <category> are overrepresented among the DE genes identified from step 9.

Within the protein (?) gene ontologies, <category> and <category> are overrepresented among the DE genes identified from step 9.
