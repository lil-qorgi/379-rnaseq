...
We focus on two of the five figures generated by the cummeRbund script for results and discussion.

### Figures of focus

TODO Keep only two to focus on. Expand on them. Copy over from Appendix, rename by number, and expand on figure captions.
...
This appendix includes all five plots produced by the cummeRbund.R script. The five figures are arranged in order of their creation in the script.

TODO "This is equivalent to Figure 1 found in section 11D in the main body of this notebook."
TODO "This is equivalent to Figure 2 found in section 11D in the main body of this notebook."

<img alt="Figure A. Density plot" src="final_results/1_density.png" width="600"/>

**Figure A. Density plots of FPKM values for Thiamine+ (q1) and Thiamine- (q2) *Candida albicans* gene transcripts.**
...
**Figure C. Volcano plot of *Candida albicans* genes plotted on -log10(p value) versus log2(fold change) scale.** Red color highlights genes with significant differential expression between Thiamine+ and Thiamine- treatments.
